...
export default function NewLesson() {
   ...
   let pdfRef=useRef();
    ...
    async function hundleSubmit(e) {
        ...
        try {
            await axios.post(`http://localhost:5000/lessons/${currentPath}/new`, formData, {
                headers: {
    ...
    return (
        <>
            <div className="container mt-5 p-5">
                ...
                <form action="" onSubmit={hundleSubmit} className='border p-5 rounded shadow newLessoF'>
                    {/* title */}
                    <div className="mb-3">
                    ...
                    <div className="row mb-5">
                        <div className="col-md-6 mt-md-3 mb-3 mb-md-0">
                            ...
                            <input type="file" id="imageInput" name='videoApload' ref={videoRef} onChange={displayThumbnail} required /><br />
                        </div>
                    ...
                    <div className="row">
                        ...
                        <Link to={`/lessons/${currentPath}`} name="action" value='cancel' className="btn btn-danger px-3">Cancel</Link>
                        {/* <button type="reset" name="action" value='cancel' className="btn btn-danger px-3">Cancel</button> */}
